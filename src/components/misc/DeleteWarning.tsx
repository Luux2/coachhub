...
export const DeleteWarning = ({onClose}: {onClose: () => void }) => {
    return (
        <div className="overflow-hidden rounded-lg shadow-2xl bg-white p-4 text-white">
            ...
            <p className="text-gray-500 text-xl italic my-4 text-center">Du er ved at slette et klippekort og alle tilknyttede
                opgaver.</p>
